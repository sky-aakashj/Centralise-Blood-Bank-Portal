...
<head>
    ...
    <title>Dashboard-Create Camp </title>
        ...
        <div class="container">
            <div class="row ">
                <div class="col-md-4 py-5 bg-danger text-white text-center ">
                    <div class=" ">
                        <div class="card-body">
                            <img src="images/camp.png" style="width:80%">
                            <h2 class="py-3">Create New Camp</h2>
                            <p>
                ...
                <div class="col-md-8 py-5 border">
                    <h4 class="pb-4">Please fill the camp details</h4>
                    <form action="campaction.php" method="POST" autocomplete="off">
                        <div class="form-row">
                            <div class="form-group col-md-6">
                                <input id="campname" name=" campname" placeholder="Camp Name"
                        ...
                        <div class="form-row">
                            ...
                            <input id="add"  name="address"placeholder="enter address" class="form-control" type="text" required="required">
